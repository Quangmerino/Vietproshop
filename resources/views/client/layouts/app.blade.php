...
<head>
	...
	<title>Vietpro - @yield('title')</title>
	<meta name="viewport" content="width=device-width, initial-scale=1">
    <base href="{{asset('')}}vietpro-store-basic/Start/frontend/">
	<!-- Animate.css -->
                        ...
                        <div class="col-md-6 col-md-offset-3 col-md-pull-2 col-sm-12 col-xs-12 slider-text">
                            <div class="slider-text-inner">
                                <div class="desc">
                                    ...
                                    <h2 class="head-3">45%</h2>
                                    <p class="category"><span>Nhưng mẫu thiết kế chuyên nghiệp</span></p>
                                    <a href="{{route('home.contact')}}" class="btn btn-primary">Kết nối với shop</a>
                                </div>
                            </div>
                        </div>
                    </div>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2">
						...
						<div class="col-md-6">
							<form class="form-inline qbstp-header-subscribe" action="{{route('home.subscribe')}}" method="POST">
								@csrf
								<div class="row">
