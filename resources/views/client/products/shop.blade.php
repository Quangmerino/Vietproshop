		...
		<div class="row">
					...
					<div class="col-md-4 text-center">
						<div class="product-entry">
							<div class="product-img" style="background-image: url(/uploads/{{$item->image}});">
								...
								<div class="cart">
									<p>
									    <span class="addtocart"><a href="/carts/addCart?id_product={{$item->id}}"><i
													class="icon-shopping-cart"></i></a></span>
										<span><a href="{{route('products.detail',$item->slug)}}"><i class="icon-eye"></i></a></span>
							...
							<div class="desc">
								<h3><a href="{{route('products.detail',$item->slug)}}">{{$item->name}}</a></h3>
			...
			<div class="col-md-3 col-md-pull-9">
				<div class="sidebar">
									...
									<div class="panel-heading" role="tab" id="headingOne">
										<h4 class="panel-title">
											<a data-toggle="collapse" data-parent="#accordion" href="#menu{{$category->id}}"
												aria-expanded="true" aria-controls="collapseOne">{{$category->name}}</a>
										</h4>
									</div>
					...
					<div class="side">
						<h2>Khoảng giá</h2>
					      <form method="GET" action="{{route('products.filter')}}" class="colorlib-form-2">
							<div class="row">
								<div class="col-md-12">
